...
<script>
  ...
  <div class="mb-3">
    ...
    <input id="NUM_EXISTENCIA" name="NUM_EXISTENCIA" type="number" class="form-control" tabindex="1" autocomplete="off" autofocus="on" onkeypress="return isNumberKey(event)" autofocus required="" pattern="[0-9]+" value="{{$persona->num_existencia}}">    
  </div>
