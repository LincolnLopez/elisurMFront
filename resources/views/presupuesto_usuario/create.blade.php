                    ...
                    <form action="/presupuesto_usuario" method="POST">
                        @csrf
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-">
                                    <input id="CORREO_ELECTRONICO" name="CORREO_ELECTRONICO" type="text" class="form-control" placeholder="TCORREO ELECTRONICO">
                                </div>
                            </div>
                        ...
                        <tr>
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-">
                                    <textarea id="DIRECCION_SOLICITANTE" name="DIRECCION_SOLICITANTE" rows="1" class="form-control" placeholder="Dirección"></textarea>
                                </div>
                                <div class="form-group col-md-">
                                ...
                                <div class="form-group col-md-">
                                    <textarea id="DESCRIPCION_SOLICITUD" name="DESCRIPCION_SOLICITUD" rows="1" class="form-control" placeholder="DESCRIPCION"></textarea>
                                </div>
                            </div>
                        ...
                        <button href="/bitacora_cliente.index" type="submit" class="btn btn-primary" tabindex="4">Guard--ar</button>

                        <a href="{{ route('bitacora_cliente.index') }}" class="btn btn-success">Gu</a>
