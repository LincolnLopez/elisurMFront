          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <div class="mb-3">
                ...
                <input id="NOMBRE_ARTICULO" name="NOMBRE_ARTICULO" type="text" class="form-control" tabindex="1" autocomplete="off" autofocus="on"  onkeyup="DobleEspacio(this, event);" o onPaste="return false;" autofocus required>
              </div>
              ...
              <div class="mb-3">
                ...
                <input id="DESCRIPCION_ARTICULO" name="DESCRIPCION_ARTICULO" type="text" class="form-control" tabindex="1" autocomplete="off" autofocus="on"  onkeyup="DobleEspacio(this, event);"required>
              </div>
