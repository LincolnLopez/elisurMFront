          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <div class="mb-3">
                ...
                <input id="NOMBRE" name="NOMBRE" type="text" class="form-control" tabindex="1" autocomplete="off" autofocus="on"  onkeyup="DobleEspacio(this, event);" autofocus required="" pattern="[a-z A-Z ñÑ ÁÉÍÓÚáéíóú ]+">
              </div>
              ...
              <div class="mb-3">
                ...
                <input id="TEMA" name="TEMA" type="text" class="form-control" tabindex="1" autocomplete="off" autofocus="on" onkeyup="DobleEspacio(this, event);" required>
              </div>

              <div class="mb-3">
                <label for="" class="form-label">Descripción</label>
                <input id="DESCRIPCION" name="DESCRIPCION" type="text" class="form-control" tabindex="1" autocomplete="off" autofocus="on" onkeyup="DobleEspacio(this, event);" required>
              </div>

              <div class="mb-3">
                <label for="" class="form-label">Ubicación</label>
                <input id="UBICACION" name="UBICACION" type="text" class="form-control" tabindex="1" autocomplete="off" autofocus="on"  onkeyup="DobleEspacio(this, event);"required>
              </div>
