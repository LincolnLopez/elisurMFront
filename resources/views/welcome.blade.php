...
<body>
   ...
   <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px" id="band">
      ...
      <p class="w3-justify">Un equipo de profesionales con 10 años de experiencia en la dirección de algunas de las mayores compañías nacionales,
         ...
         Ofrecemos nuestra capacidad de gestión, aplicando las mejoras tecnológicas de la gran empresa, junto al trato cercano, flexible y
         personalizado de las PYMES, y nuestra innata creatividad, para ofrecer servicios sostenibles, de calidad, que aporten valor y se
      ...
      <div class="w3-container w3-content w3-padding-64" style="max-width:1000px">
         ...
         <div class="w3-row-padding w3-padding-32" style="margin:0 -16px">
            <div class="w3-quarter w3-margin-bottom">
               <img src="https://www.tecnoseguro.com/media/k2/items/cache/210438cfc59c1719a9deba5dc66d5c69_XL.jpg" alt="Camaras" width="100%" height="130" class="w3-hover-opacity">
               <div class="w3-container w3-white">
                  <p><b>Sistema de Seguridad</b></p>
                  <p>Elisur ofrece instalación de cámaras de seguridad.</p>
                  <button class="w3-button w3-black w3-margin-bottom" onclick="document.getElementById('ticketModal').style.display='block'">Cotizar</button>
               </div>
            </div>
            <div class="w3-quarter w3-margin-bottom">
               <img src="https://morse-ti.net/wp-content/uploads/2019/11/morse-ti-monitoreo-img-01.jpg" alt="CCTV" width="100%" height="130" class="w3-hover-opacity">
               <div class="w3-container w3-white">
            ...
            <div class="w3-quarter w3-margin-bottom">
               <img src="https://fge.pe/wp-content/uploads/2020/07/servicios-de-construcci%C3%B3n-y-mantenimiento-en-lima-peru.jpg" alt="Construccion" width="100%" height="130" style="width:100%" class="w3-hover-opacity">
               <div class="w3-container w3-white">
            ...
            <div class="w3-quarter w3-margin-bottom">
               <img src="https://distribuidoramariscal.com.gt/wp-content/uploads/2021/06/tablayeso-f.jpg" alt="tablayeso" width="100%" height="130" class="w3-hover-opacity">
               <div class="w3-container w3-white">
                  <p><b>Tabla Yeso</b></p>
         ...
         <div class="w3-row-padding w3-padding-32" style="margin:0 -16px">
            <div class="w3-quarter w3-margin-bottom">
               <img src="https://homesolution.net/blog/wp-content/uploads/2019/02/carga-de-gas-para-split-aire-acondicionado-D_NQ_NP_916847-MLA26619046313_012018-F.jpeg" alt="aire" width="100%" height="130" class="w3-hover-opacity">
               <div class="w3-container w3-white">
            ...
            <div class="w3-quarter w3-margin-bottom">
               <img src="https://www.asep.gob.pa/wp-content/uploads/2018/03/01-2-3300x2100_ELEC.jpg" alt="electricidad" width="100%" height="130" class="w3-hover-opacity">
               <div class="w3-container w3-white">
            ...
            <div class="w3-quarter w3-margin-bottom">
               <img src="https://www.reformadisimo.es/wp-content/uploads/2019/11/pintar-las-paredes-de-casa.jpg" alt="pintura" width="100%" height="130" class="w3-hover-opacity">
               <div class="w3-container w3-white">
                  <p><b>Pintura</b></p>
            ...
            <div class="w3-quarter w3-margin-bottom">
               <img src="https://www.fastnetworkhn.com/wp-content/uploads/PLANTA-TELEFONICA-IP-GRANDSTREAM-UCM6204.jpg" alt="pintura" width="100%" height="130" class="w3-hover-opacity">
               <div class="w3-container w3-white">
   ...
   <div id="ticketModal" class="w3-modal">
      <div class="w3-modal-content w3-animate-top w3-card-4">
         <header class="w3-container w3-center w3-padding-5">
            <span onclick="document.getElementById('ticketModal').style.display='none'" class="w3-button w3-xlarge w3-display-topright">×</span>
