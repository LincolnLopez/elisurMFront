                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="COD_CLIENTE" name="COD_CLIENTE" type="text" class="form-control"
                                    value="{{ $cliente->cod_cliente }}" readonly>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="NOMBRE_CLIENTE" name="NOMBRE_CLIENTE" type="text" class="form-control"
                                    autocomplete="off" autofocus="on" o onPaste="return false;" required
                                    onkeyup="nospaces2();" required value="{{ $cliente->nombre_cliente }}">
                            </div>

                            <div class="mb-3">
                                <label for="" class="form-label">Apellidos</label>
                                <input id="APELLIDOS_CLIENTE" name="APELLIDOS_CLIENTE" type="text" class="form-control"
                                    autofocus="on" onkeyup="return nospaces1()" onPaste="return false;"required
                            ...
                            <div class="mb-3">
                                ...
                                <input id="CORREO_CLIENTE" name="CORREO_CLIENTE" type="text" class="form-control"
                            ...
                            <select class="form-control" id="COD_TIPO_CLIENTE" name="COD_TIPO_CLIENTE"
                                value="{{ $cliente->cod_tipo_cliente }}">
