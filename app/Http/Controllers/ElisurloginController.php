...
class ELisurloginController extends Controller
{
    /**
    ...
    {
        $elisurlogin = Http::withToken('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjowfSwiaWF0IjoxNjY4OTIyMjY2fQ.ZknZ8Fk77oKHICyGfN5t3IDMYt9RMz12SX_CAcWy0Ps
        ')->get('http://localhost:3000/inventarios');
        return view('elisurlogin.index')->with('inventarios',json_decode($elisurlogin));
    ...
    public function create()
    {
        ...
        return view('elisurlogin.create');
